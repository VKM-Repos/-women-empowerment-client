                        ...
                        <div className="bg-white flex flex-col w-full pt-11 pb-5 px-20 rounded-2xl border border-stone-800 border-solid border-black border-opacity-10 max-md:max-w-full max-md:mt-10 max-md:px-5">
                            ...
                            <div className='flex flex-col gap-5 mt-7'>
                                ...
                                <div className='flex items-center gap-5'>
                                    ...
                                    <input type='text' className="font-quickSand flex-1 border border-stone-800 border-solid border-black border-opacity-10 px-10 py-3 focus:outline-none rounded-md w-full" placeholder='sarahbling@gmail.com' />
                                </div>
                                <div className="flex items-center gap-5">
                                    <label className='font-sora flex-[0.3] w-full' htmlFor="">Password</label>
                                    <div className='flex-1 flex border border-stone-800 border-solid border-black border-opacity-10 rounded-md px-8  py-3 w-full items-center'>
                                        <input type={showPassword ? 'text' : 'password'} className="font-quickSand flex-1 focus:outline-none w-full" placeholder='****************' />
                                        {showPassword
