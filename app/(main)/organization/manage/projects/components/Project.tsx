...
export default function Event({
  ...
  return (
    <div className="cursor-pointer hover:bg-slate-200 flex justify-between items-center border border-gray-500 p-2 rounded-md w-[700px]">
          ...
          {includeMenu && (
            <div className="relative">
              <Menu
                ...
                menuItems={
                  projectStatus == "Drafts" ? eventDraftMenu : eventMenu
                }
              />
            </div>
          )}
