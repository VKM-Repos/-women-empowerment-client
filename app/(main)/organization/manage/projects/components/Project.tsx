...
export default function Event({ project, projectStatus }: EventCardProps) {
      ...
      <div className="flex items-start gap-5">
        <div>
          <Image
            ...
            className="w-[200px] max-w-[200px] aspect-square object-cover"
            width={200}
            height={200}
          />
        </div>
        <div className="flex flex-col items-start">
          ...
          <p className="text-sm  font-quickSand text-black-100 w-[350px]">
            {project?.description}
          </p>
