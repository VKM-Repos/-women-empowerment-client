      ...
      <fieldset>
        ...
        <div className="w-[60%] grid grid-cols-3 gap-7 md:grid-cols-4 items-center">
          ...
          <DateInput
            ...
            onChange={(field, value) => setDate({ ...date, [field]: value })}
          />
          <button className="flex flex-row-reverse md:flex-col gap-1 items-center justify-center bg-btnWarning active:bg-gray-400 h-[70%] w-[70%] rounded-md text-primaryWhite">
            <span>
              <svg
                width="25"
                height="25"
