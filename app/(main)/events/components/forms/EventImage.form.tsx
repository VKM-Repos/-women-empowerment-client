...
const EventImage: React.FC<EventImageProps> = ({ handleNext, handleGoBack }) => {
  ...
  return (
      <div className="w-full md:w-3/4 mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10 items-center lg:p-12 p-4 font-quickSand">
        <div className="w-full lg:col-span-2 hidden lg:flex flex-col gap-5 place-self-start">
          <p className="text-lg font-quickSand font-semibold text-primary">3 of 3</p>
          <h2 className="text-2xl font-sora text-gray-100 font-semibold">Visual Representation</h2>
          <p className="text-lg text-gray-300 font-sora">Add an image that represents your event</p>
        </div>
