    ...
    <>
      {isLoading || !events ? (
        ...
        <AnimatePresence initial={false} mode="wait">
          <div className="w-2/3 mx-auto bg-[#F6F7F8] flex flex-col gap-10 items-center h-full p-6 rounded-[1rem] relative mt-6 mb-[7rem]">
              ...
              <div className="col-span-1 flex flex-col items-start justify-start gap-5">
                ...
                <div className="bg-primaryWhite w-full rounded-lg drop-shadow-sm p-4 flex flex-col gap-5">
                  <p className="text-sm text-gray-200">
                    ...
                    the world of writing? Whether you&apos;re a seasoned writer
                    or just starting your writing journey, our Writing Club is
                    the perfect place for you. Join us to reflect on our
                    blogging experience of this year and get inspiration!
                  </p>
                </div>
              </div>
            </div>
