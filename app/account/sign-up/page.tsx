...
const SignUp: React.FC = () => {
  ...
  const { mutate, isPending, isError } = usePOST('/register')
    ...
    <TransitionParent>
      <main >
          ...
          <div className="h-screen w-screen px-5 py-2 ">
            <button onClick={() => router.push('/')} className="flex gap-2 items-center text-btnWarning font-bold md:text-xl text-sm w-fit absolute top-10 left-10">
            ...
            <div className="flex justify-center items-center w-full">
              ...
              <div className="w-1/2 flex flex-col items-center px-5 py-10 gap-[16px] overflow-auto">
                ...
                <div className="items-stretch w-[450px] flex flex-col pt-10 pb-8 rounded-2xl h-full">
                  <img
                    loading="lazy"
                    srcSet={`${Logo.src}`}
                  ...
                  <div className="flex w-full flex-col mt-4 px-4 max-md:max-w-full">
                    <form action="" className="flex flex-col" onSubmit={handleSignUp}>
                      <div className="text-stone-500 text-sm whitespace-nowrap border border-stone-800 bg-white-100 self-stretch justify-center px-5 py-4 rounded-lg border-solid border-black border-opacity-10 items-start max-md:max-w-full max-md:px-5">
                        <input type="email" name="email" value={formData?.email} onChange={handleInputChange} placeholder="Email" className="w-full focus:outline-none" required />
                      </div>
                    ...
                    <div  className="text-green-800 text-sm  self-center whitespace-nowrap mt-4">
                      ...
                      <Link href="/account/login" className="font-medium underline text-green-800">Log in</Link>
                    </div>
                  </div>
                </div>
