          ...
          >
            <div className="w-full z-[4000]">
               <div className="w-full bg-primaryWhite flex flex-col items-start justify-start gap-2 text-xs">
                  {/* copy link */}
                  <button onClick={handleCopyClick} className="w-full p-1 flex items-center justify-start gap-2 text-gray-300 hover:bg-primary/10 rounded">
                    <svg  className="w-6 aspect-square"
                      viewBox="0 0 30 30"
                      fill="none"
                  ...
                  {/* facebook share */}
                  <button onClick={handleFacebookShare} className="w-full p-1 flex items-center justify-start gap-2 text-gray-300 hover:bg-primary/10 rounded">
                     <svg
                  ...
                  {/* twitter share */}
                  <button onClick={handleTwitterShare} className="w-full p-1 flex items-center justify-start gap-2 text-gray-300 hover:bg-primary/10 rounded">
                    <svg
                      className="w-6 aspect-square"
                      viewBox="0 0 40 40"
                      fill="none"
                  ...
                  {/* linkedin share */}
                  <button onClick={handleLinkedInShare} className="w-full p-1 flex items-center justify-start gap-2 text-gray-300 hover:bg-primary/10 rounded">
                               <svg
                      className="w-6 aspect-square"
                      viewBox="0 0 40 40"
                      fill="none"
