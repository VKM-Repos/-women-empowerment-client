  ...
  const links = {
    ...
    accountNav: [
...

      {
        ...
        icon: (
          ...
          >
            ...
            <g clip-path="url(#clip0_7403_23678)">
              ...
              />
              <path
                d="M20.0003 28.5H17.0002V31.0714H11.8574V27H13.1431H15.7146H17.2146H19.786H21.286H23.8574H25.1431V31.0714H20.0003V28.5ZM23.8574 29.7857V28.2857H22.1431V29.7857H23.8574ZM14.8574 29.7857V28.2857H13.1431V29.7857H14.8574Z"
                fill="#A67C52"
              />
              <path
              ...
              />
              <path
                d="M25.1431 17.7852V21.8566H23.8574V19.2851H21.286V21.8566H19.786V19.2851H17.2146V21.8566H15.7146V19.2851H13.1431V21.8566H11.8574V17.7852H13.1431H15.7146H17.2146H19.786H21.286H23.8574H25.1431Z"
                fill="#A67C52"
              />
              <path
              ...
              />
              <path
                d="M23.8566 24.4297H21.2852V27.0011H23.8566V24.4297Z"
                fill="#F2F2F2"
              />
              <path
              ...
              />
              <path
                d="M23.8566 15.2148H21.2852V17.7863H23.8566V15.2148Z"
                fill="#F2F2F2"
              />
              <path d="M20 28.5H17V31.0714H20V28.5Z" fill="#F2F2F2" />
              <path
                d="M19.7863 24.4297H17.2148V27.0011H19.7863V24.4297Z"
                fill="#F2F2F2"
              />
              <path
              ...
              />
              <path
                d="M19.7863 15.2148H17.2148V17.7863H19.7863V15.2148Z"
                fill="#F2F2F2"
              />
              <path
                d="M15.714 24.4297H13.1426V27.0011H15.714V24.4297Z"
                fill="#F2F2F2"
              />
              <path
              ...
              />
              <path
                d="M15.714 15.2148H13.1426V17.7863H15.714V15.2148Z"
                fill="#F2F2F2"
              />
              <path
              ...
              />
              <path
                d="M12.8223 30.1077H15.1794V27.9648H12.8223V30.1077ZM13.4651 28.6077H14.5365V29.4648H13.4651V28.6077Z"
                fill="black"
              />
              <path
                d="M21.8223 30.1077H24.1794V27.9648H21.8223V30.1077ZM22.4651 28.6077H23.5365V29.4648H22.4651V28.6077Z"
                fill="black"
              />
            </g>
            <defs>
        ...
        showArrow: false,
        submenu: true,
        sublinks: user?.role == "USER" ? userWithNoOrgMenu : userWithOrgMenu,
      },
    ],
  };
  return (
