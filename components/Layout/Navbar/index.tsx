...
const Navbar = () => {
  ...
  const submenuLinks = {
    ...
    userWithOrgMenu: [
      ...
      </svg>, text: "Manage Organization", href: "/organization/manage/dashboard" },
      { type: 'link', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav className="fixed top-0 inset-x-0 z-[250] font-sora flex items-center justify-between text-secondaryGreen bg-primaryWhite px-2 md:px-8 py-3 md:py-0">
        ...
        </div>
        {
          ...
          <div className="flex flex-col gap-5 mt-[100px] text-lg">
            <MenuItem
             link="/about" subLinks={null} text="about" />
            <MenuItem
             link="/category" subLinks={null} text="category" />
            <MenuItem
             link="/events" subLinks={null} text="events" />
            <MenuItem
            ...
            />
            <MenuItem
             link="/projects" subLinks={null} text="projects" />
            <MenuItem
             link="/blog" subLinks={null} text="blog" />
          ...
          {!isAuthenticated ? (
            ...
            <MenuContainer>
              ...
              <MenuItem
                ...
                link=""
                subLinks={user?.role == 'USER' ? submenuLinks.userWithNoOrgMenu : submenuLinks.userWithOrgMenu}
                text=""
                icon={
